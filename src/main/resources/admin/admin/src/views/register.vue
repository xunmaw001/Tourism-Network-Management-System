    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">旅游网管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="旅游公司名称" class="input" v-if="tableName=='shangjia'">
                            <el-input v-model="ruleForm.shangjiaName" autocomplete="off" placeholder="旅游公司名称"  />
                        </el-form-item>
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/lvyouwangguanli/img/back-img-bg.jpg);
