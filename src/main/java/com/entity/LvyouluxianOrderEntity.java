...
public class LvyouluxianOrderEntity<T> implements Serializable {
    ...
    @TableField(value = "lvyouluxian_order_time")

    private Date lvyouluxianOrderTime;
	 ...
	 * 获取：预约时间
	 */
    public Date getLvyouluxianOrderTime() {
        return lvyouluxianOrderTime;
    }
    /**
	 * 设置：预约时间
	 */

    public void setLvyouluxianOrderTime(Date lvyouluxianOrderTime) {
        this.lvyouluxianOrderTime = lvyouluxianOrderTime;
    }
    /**
	 * 获取：实付价格
	 */
    ...
    public String toString() {
        return "LvyouluxianOrder{" +
            ...
            ", yonghuId=" + yonghuId +
            ", buyNumber=" + buyNumber +
            ", lvyouluxianOrderTime=" + DateUtil.convertString(lvyouluxianOrderTime,"yyyy-MM-dd") +
