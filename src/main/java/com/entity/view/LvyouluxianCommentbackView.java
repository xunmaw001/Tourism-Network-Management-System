...
public class LvyouluxianCommentbackView extends LvyouluxianCommentbackEntity implements Serializable {
	...
	public LvyouluxianCommentbackView() {

	}

	public LvyouluxianCommentbackView(LvyouluxianCommentbackEntity lvyouluxianCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, lvyouluxianCommentbackEntity);
	...
	public String toString() {
		return "LvyouluxianCommentbackView{" +
