...
//                            shangjiaEntity.setShangjiaName(data.get(0));                    //旅游公司名称 要改的
...
//                            shangjiaEntity.setShangjiaXingjiTypes(Integer.valueOf(data.get(0)));   //旅游公司信用类型 要改的
...
//                            shangjiaEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(shangjia.getId(),username, "shangjia", "旅游公司");
        R r = R.ok();
        r.put("token", token);
        r.put("role","旅游公司");
